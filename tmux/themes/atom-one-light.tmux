...
set -g status-right "#[fg=${CYAN},bg=${BG}]#[fg=${ON_ACCENT},bg=${CYAN},bold]  %H:%M #[fg=${CYAN},bg=${BG}] #[fg=${MAGENTA},bg=${BG}]#[fg=${ON_ACCENT},bg=${MAGENTA},bold]  %d %b #[fg=${MAGENTA},bg=${BG},nobold]"
